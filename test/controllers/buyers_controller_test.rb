...
class BuyersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buyer" do
    assert_difference("Buyer.count") do
      post buyers_url, params: { buyer: { b_dob: @buyer.b_dob, b_id: @buyer.b_id, b_name: @buyer.b_name } }
    end
  ...
  test "should update buyer" do
    patch buyer_url(@buyer), params: { buyer: { b_dob: @buyer.b_dob, b_id: @buyer.b_id, b_name: @buyer.b_name } }
